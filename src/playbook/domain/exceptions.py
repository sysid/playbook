...
class NodeExecutionError(ExecutionError):
    ...
    def __init__(self, message: str, node_id: str, node_type: Optional[str] = None,
                 context: Optional[Dict[str, Any]] = None, suggestion: Optional[str] = None):
...
class CommandExecutionError(NodeExecutionError):
    ...
    def __init__(self, message: str, node_id: str, command: str,
                 exit_code: Optional[int] = None, stdout: Optional[str] = None, stderr: Optional[str] = None,
                 context: Optional[Dict[str, Any]] = None, suggestion: Optional[str] = None):
...
class FunctionExecutionError(NodeExecutionError):
    ...
    def __init__(self, message: str, node_id: str, function_name: str,
                 context: Optional[Dict[str, Any]] = None, suggestion: Optional[str] = None):
